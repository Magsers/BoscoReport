...
\begin{itemize}
  \item Sprint planning. 
    ...
    \end{itemize}
  \item Amazon Web servicesin particular 
    \begin{itemize}
      \item Lambda 
      \item Step Functions 
      \item CloudFormation 
...
\begin{itemize}
  \item It became obvious early in the process that the fundamentals of Javascript and object orientated programming were still challenging and not fully comprehended. However, from being assigned new tasks every week, which explored 
  varioius components, AWS services, features and technologies, a steep learning curve was overcome and skills were achieved at a pace which inevitably sped up the process.
  ...
  \item Mastering Puppeteer. Accessing the selectors on the Lightning page was tricky in comparison to Testcafe which uses a variety of methods to access the elements and is in reality more straight forward and easier to read.
...
There is in total thirty Frankenstein Testcafe tests of which four are already transitioned to Bosco. Any team member once lightly versed in Puppeteer and Mocha can now transition easily. 
